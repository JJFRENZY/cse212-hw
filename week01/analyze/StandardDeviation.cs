...
public static class StandardDeviation
{
    public static void Run()
    {
        ...
        Console.WriteLine("StandardDeviation1: " + StandardDeviation1(numbers)); // ~147.322
        Console.WriteLine("StandardDeviation2: " + StandardDeviation2(numbers)); // ~147.322
        Console.WriteLine("StandardDeviation3: " + StandardDeviation3(numbers)); // ~147.322
    }
